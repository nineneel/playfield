                ...
                <div
                    ...
                    <div class="p-6 sm:p-8">
                        <div class="flex flex-col items-center mb-5">
                            <h3 class="font-bold text-2xl text-center mb-1 uppercaselg:text-4xl">Tell Us What You’re <br />
                                not Interested With</h3>
                        </div>

                        <form action="/signup_3" method="POST" class="flex flex-col gap-4">
                            @csrf
                                ...
                                @foreach ($items as $item)
                                    <li>
                                        <input type="checkbox" id={{ $item['name'] }}
                                            value="{{ strtolower($item['name']) }}" class="hidden peer" name="dislikes[]">
