...
@section('container')
    ...
    <div class="col-lg-8">
        ...
        <form action="/admin/dashboard/products" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('content') is-invalid  @enderror" name="content" id="content" rows="2">{{ old('content') }}</textarea>
                @error('content')
                    <p class="text-danger">
                        {{ $message }}
                    </p>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('donts') is-invalid  @enderror" name="donts" id="donts" rows="2">{{ old('donts') }}</textarea>
                @error('donts')
                    <div id="validationServer03Feedback" class="invalid-feedback">
                        {{ $message }}
                    </div>
