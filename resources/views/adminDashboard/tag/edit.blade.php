...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Facility</h1>
    </div>

    <div class="col-lg-6">

        <form action="/admin/dashboard/facilities/{{ $facility->id }}" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('image', $facility->image) is-invalid @enderror" type="file"
